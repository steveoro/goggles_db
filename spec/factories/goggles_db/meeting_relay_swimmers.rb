FactoryBot.define do
  factory :meeting_relay_swimmer, class: 'GogglesDb::MeetingRelaySwimmer' do
    ...
    meeting_relay_result { FactoryBot.create(:meeting_relay_result) }
    stroke_type do
    ...
    badge   { FactoryBot.create(:badge, season: meeting_relay_result.team_affiliation.season, team: meeting_relay_result.team) }
