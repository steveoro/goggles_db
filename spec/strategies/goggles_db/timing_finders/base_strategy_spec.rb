  ...
  RSpec.describe TimingFinders::BaseStrategy, type: :strategy do
    ...
    describe '#search_by' do
      context 'when the parameters scope out existing MIRs,' do
        subject { TimingFinders::BaseStrategy.new.search_by(fixture_swimmer, nil, fixture_event_type, fixture_pool_type) }
      ...
      context 'when the parameters do not relate to any of the existing MIRs,' do
        ...
        subject { TimingFinders::BaseStrategy.new.search_by(new_swimmer, nil, fixture_event_type, fixture_pool_type) }
