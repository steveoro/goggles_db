...
module GogglesDb
  ...
  module Calculators
    #
    # = CSIScore strategy object
    #
    #   - version:  7-0.3.36
    #   - author:   Steve A.
    #   - build:    20211028
    #
    # Allows to compute a CSI championship/season scoring (or timing from a score)
    # given the constructor parameters.
    #
    class CSIScore < BaseStrategy
      # (no customizations so far)
      # TODO: add CSI-specific rules here
    end
  end
end
