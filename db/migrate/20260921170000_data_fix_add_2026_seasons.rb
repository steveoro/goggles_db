...
class DataFixAdd2026Seasons < ActiveRecord::Migration[6.0]
  def self.up
    base_year = 2026
    ...
    [
      ...
      # - 2026 (id 253) => (Missing) ed. 20 (Savorin, Slovacchia), 2026-08-18 .. 2026-08-24 (50m)
      {
        id: 253,
        edition: 20,
        description: 'Campionato Europeo Master LEN 2026 (Savorin, Slovacchia)',
        header_year: '2026',
        begin_date: Date.parse('2026/08/18'),
        end_date: Date.parse('2026/08/24'),
      ...
      # => base_id: 4
      #
      # Latest FINA Editions:
      # - 2019 (id 184) => ed. 18 (Gwangju, KOR)
      # - 2023 (id 224) => ed. 19 (Fukuoka, JPN), 2023-08-02 .. 2023-08-11
      # - 2024 (id 234) => ed. 20 (Doha, QAT), 2024-02-23 .. 2024-03-03 (possible id ~234)
      # - 2025 (id 244) => ed. 21 (Singapore)
      # - 2027 (id 264) => ed. 22 (Budapest, Hungary)
      # ---
      {
        id: 264,
        edition: 22,
        description: 'FINA World Aquatics Master Championship 2027 (Budapest, Hungary)',
        header_year: '2027',
        begin_date: Date.parse('2027-06-26'),
        end_date: Date.parse('2027-07-26'),
