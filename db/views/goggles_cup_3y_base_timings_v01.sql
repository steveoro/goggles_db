...
-- CTE to get all seasons with championship_year between current - 3 and current - 1
Previous3ySeasons AS (
  SELECT swc.id
  FROM SeasonWithChampionship swc
  JOIN CurrentChampionshipYear ccy ON swc.championship_year BETWEEN ccy.championship_year - 3 AND ccy.championship_year - 1
),
